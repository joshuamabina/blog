...
> **tldr** DO NOT USE `public/assets` to store your source static assets.
...
> **tldr** There is no need to deploy the project with the `node_modules` directory.
...
> **tldr** No need to deploy the entire `vendor` directory.
...
> **tldr** Shared hosting, culprit of Laravel hosting.
